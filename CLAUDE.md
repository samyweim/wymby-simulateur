...
Ce fichier décrit le contexte, le périmètre et les contraintes du moteur décisionnel fiscal intégré à WYMBY. Il sert de référence pour tout agent IA (Claude Code ou autre) chargé d'implémenter, auditer ou étendre ce moteur.
