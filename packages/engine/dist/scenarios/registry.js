...
exports.getScenariosForSegment = getScenariosForSegment;
...
function getScenariosForSegment(segment) {
    return Object.values(exports.SCENARIO_REGISTRY).filter((s) => s.segment === segment);
}
