...
exports.f_cotisations_assimile_salarie = f_cotisations_assimile_salarie;
/**
 ...
 */
function f_cotisations_assimile_salarie(remuneration_brute, params) {
    ...
    const assiette_csg = remuneration_brute <= pass * 4
        ? remuneration_brute * 0.9825
        : remuneration_brute;
    for (const ligne of lignes) {
        // Exclure assurance chômage pour le président SASU
        if (ligne.libelle === "Assurance chômage")
            continue;
...
//# sourceMappingURL=cotisations-assimile.js.map