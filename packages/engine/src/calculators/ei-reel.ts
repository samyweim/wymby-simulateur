...
export function calculerEIReel(
  ...
  // ARCE is a non-recurring treasury flow applied only for BOOST_ARCE scenarios.
  ...
  return {
    intermediaires: {
      ...
      CHARGES_DEDUCTIBLES: input.CHARGES_DEDUCTIBLES > 0 ? input.CHARGES_DEDUCTIBLES : undefined,
      DOTATIONS_AMORTISSEMENTS: amortissements > 0 ? amortissements : undefined,
      RESULTAT_COMPTABLE,
      RESULTAT_FISCAL_AVANT_EXONERATIONS,
