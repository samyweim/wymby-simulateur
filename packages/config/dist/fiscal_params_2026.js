...
exports.FISCAL_PARAMS_2026 = {
    ...
    micro: {
         ...
         */
        CFG_NOTE_ACTIVITES_MIXTES: "CA global ≤ 203 100 € HT, dont part services/BNC ≤ 83 600 € HT",
    },
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    vfl: {
         ...
         */
        CFG_FORMULE_SEUIL_RFR_VFL: (nbParts) => 29_315 * nbParts,
    ...
    social: {
        ...
        CFG_TAUX_SOCIAL_TNS_BIC: {
            ...
            note_generale: "Taux effectif global non fixe — varie selon le niveau de revenu et les tranches. " +
        ...
        CFG_TAUX_SOCIAL_ASSIMILE_SALARIE: {
            ...
            note_president_sasu: "Le président de SASU ne cotise pas au chômage. " +
        ...
        CFG_COTISATIONS_MINIMALES_TNS_SSI: {
            ...
            get total_minimal_hors_cfp() {
                return (this.indemnites_journalieres.montant +
                    this.retraite_base.montant +
                    this.invalidite_deces.montant);
            },
            note: "Ces assiettes minimales sont indépendantes de l'assiette ASU (abattement 26 %). " +
        ...
        CFG_REGLES_ASSIETTE_SOCIALE_UNIQUE_IR: {
            ...
            note: "L'assiette ASU est utilisée à la fois pour les cotisations contributives ET la CSG-CRDS. " +
        ...
        CFG_REGLES_ASSIETTE_SOCIALE_DIVIDENDES_ASSIMILE: {
            ...
            note: "Hausse CSG +1,4 pt (LFSS 2026) : PS passent de 17,2 % à 18,6 % sur dividendes SASU. " +
        ...
        CFG_FORMULE_TAXE_PUMA: {
            taux: 0.065,
            formule: "T = 0.065 × (A − 0.5 × PASS) × (1 − R / (0.2 × PASS))",
            variables: {
                A: "Revenus du patrimoine et du capital, plafonnés à 8 PASS (384 480 €)",
    ...
    sante: {
        ...
        CFG_PARAM_DEDUCTION_GROUPE_III: {
            ...
            note: "Déduction de 2 % des honoraires conventionnels, plafonnée à 3 050 €. " +
        ...
        CFG_PARAM_ZIP_ZAC_MONTANT_FORFAITAIRE: {
            ...
            note: "Aides versées par la CPAM en une fois pour primo-installation. " +
    ...
    immobilier: {
        ...
        CFG_REGLES_AMORTISSEMENT_LMNP_REEL: {
            ...
            seuil_immobilisation: {
                valeur_ht: 500,
                note: "En dessous de 500 € HT : possible déduction directe en charge. " +
            ...
            regle_art_39_c: {
                ...
                formule: "amortissement_deductible = min(amortissement_theorique, " +
        ...
        CFG_REGLES_PLUS_VALUES_LMNP: {
            ...
            reforme_lf_2025: {
                principe: "Les amortissements déduits (art. 39 C) sont réintégrés dans le calcul de la PV. " +
    ...
    aides: {
        ...
        CFG_TAUX_REDUCTION_ACRE_MICRO: {
            ...
            note: "Fin de l'attribution automatique — demande obligatoire sous 60 jours de début d'activité. " +
        ...
        CFG_TAUX_REDUCTION_ACRE_HORS_MICRO: {
            ...
            formule_degressivite: {
                ...
                formule: "exoneration = taux_max × (PASS − revenu) / (PASS × 0.25)",
        ...
        CFG_ACRE_MODE_CALCUL: {
            ...
            micro_entrepreneurs: {
                ...
                exemple: "BIC services : taux normal 21,2 % × (1 − 0,25) = 15,9 % après 01/07/2026",
            },
        },
        // ── 9b. ARCE ─────────────────────────────────────────────────────────────
        /** ARCE active en 2026 */
    ...
    zones: {
        ...
        CFG_NON_CUMUL_EXONERATIONS_ZONE: {
            ...
            irrevocabilite: true,
            arbitrage: "En cas de double éligibilité ZFRR/QPV, calculer les deux et présenter l'écart à l'utilisateur",
        },
    },
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    fiscal: {
        ...
        CFG_PRELEVEMENTS_SOCIAUX_CAPITAL: {
            ...
            note: "La CSG déductible reste à 6,8 % dans les deux cas (option barème IR). " +
        ...
        CFG_REGLES_REPARTITION_IR_SCENARIO: {
            ...
            formule: "IR_scenario = IR_foyer(avec_revenu_scenario) − IR_foyer(sans_revenu_scenario)",
            base_sans_scenario: "AUTRES_REVENUS_FOYER_IMPOSABLES − AUTRES_CHARGES_DEDUCTIBLES_FOYER",
            fiabilite: "Estimation si données foyer incomplètes — toujours qualifier le niveau de fiabilité",
        },
        /**
        ...
        CFG_REGLES_AFFECTATION_IMPOT_FOYER_AU_SCENARIO: {
            ...
            prelevements_sociaux: "Calculés directement sur les revenus du scénario (pas de mutualisation foyer)",
            note: "La méthode différentielle est sensible à la qualité des données foyer. " +
        ...
        CFG_PLAFOND_MADELIN_SANTE: {
            formule: "min(3,75 % × bénéfice_imposable + 7 % × PASS, 3 % × 8 × PASS)",
            ...
            note: "Le Groupe I (garanties de base contrat responsable) est intégralement déductible. " +
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    PENDING: {
        _NOTE: "Aucun paramètre en attente. Ce bloc doit rester vide en production. " +
...
//# sourceMappingURL=fiscal_params_2026.js.map