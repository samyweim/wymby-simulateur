...
export type SegmentActivite = "generaliste" | "sante" | "artiste_auteur" | "immobilier";
export type SousSegmentActivite = "achat_revente" | "prestation" | "liberal" | "medecin" | "paramedical" | "artiste_auteur" | "lmnp" | "lmp";
export type FormeJuridique = "EI" | "EURL" | "SASU" | "SELARL" | "SELAS" | "non_decide" | "autre";
export type RegimeFiscalEnvisage = "micro" | "reel" | "IR" | "IS" | "TS" | "non_decide" | "autre";
export type InputModeCA = "HT" | "TTC";
export type SituationFamiliale = "celibataire" | "marie" | "pacse" | "autre";
export type RegimeTVA = "franchise" | "reel_simplifie" | "reel_normal" | "inconnu";
export type SecteurConventionnel = "secteur_1" | "secteur_2" | "secteur_2_optam" | "secteur_2_non_optam" | "secteur_3" | "hors_convention";
export type ModeDeclarationArtisteAuteur = "BNC" | "TS";
export type TypeLocationMeublee = "longue_duree" | "tourisme_classe" | "tourisme_non_classe" | "chambre_hotes" | "autre";
export type OptionExonerationZone = "ZFRR" | "ZFRR_PLUS" | "QPV" | "ZFU_stock" | "aucune";
export type BaseScenarioId = "G_MBIC_VENTE" | "G_MBIC_SERVICE" | "G_MBNC" | "G_EI_REEL_BIC_IR" | "G_EI_REEL_BIC_IS" | "G_EI_REEL_BNC_IR" | "G_EI_REEL_BNC_IS" | "G_EURL_IS" | "G_EURL_IR" | "G_SASU_IS" | "G_SASU_IR" | "S_RSPM" | "S_MICRO_BNC_SECTEUR_1" | "S_MICRO_BNC_SECTEUR_2" | "S_EI_REEL_SECTEUR_1" | "S_EI_REEL_SECTEUR_2_OPTAM" | "S_EI_REEL_SECTEUR_2_NON_OPTAM" | "S_EI_REEL_SECTEUR_3_HORS_CONVENTION" | "S_SELARL_IS" | "S_SELAS_IS" | "A_BNC_MICRO" | "A_BNC_MICRO_TVA_FRANCHISE" | "A_BNC_MICRO_TVA_COLLECTEE" | "A_BNC_REEL" | "A_TS_ABATTEMENT_FORFAITAIRE" | "A_TS_FRAIS_REELS" | "I_LMNP_MICRO" | "I_LMNP_REEL" | "I_LMP";
export type BoosterId = "BOOST_ACRE" | "BOOST_ARCE" | "BOOST_ZFRR" | "BOOST_ZFRR_PLUS" | "BOOST_QPV" | "BOOST_ZFU_STOCK" | "BOOST_ZIP_ZAC" | "BOOST_CPAM" | "BOOST_RAAP_REDUIT";
...
export interface UserInput extends UserInputProfil, UserInputActivite, UserInputFoyer, UserInputTVA, UserInputTemporalite, UserInputSante, UserInputArtisteAuteur, UserInputImmobilier, UserInputAides, UserInputQualite {
}
