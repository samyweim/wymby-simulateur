...
export const FISCAL_PARAMS_2026 = {
  ...
  social: {
    ...
    CFG_TAUX_SOCIAL_TNS_BIC: {
      ...
      note_generale:
        "Taux effectif global estimé : ~43-45 % pour revenus autour du PASS, ~40-41 % au-delà. " +
        "Cotisation minimale forfaitaire si résultat nul ou négatif (à paramétrer séparément).",
    },
    ...
    CFG_COTISATIONS_MINIMALES_TNS_SSI: {
      maladie_maternite: {
        ...
        taux: 0.00,
        montant: 0,
        note: "Pas d'assiette minimale — taux 0 % si revenus < 20 % PASS (9 612 €)",
      },
      indemnites_journalieres: {
        assiette_minimale: PASS_2026 * 0.40,
        taux: 0.005,
        montant: 96,
        note: "40 % PASS (19 224 €) × 0,50 %",
      },
      allocations_familiales: {
        assiette_minimale: null,
        taux: 0.00,
        montant: 0,
        note: "Pas de cotisation minimale — taux 0 % si revenus < 110 % PASS (52 866 €)",
      },
      retraite_base: {
        ...
        montant: 967,
        trimestres_valides: 3,
        note: "450 × SMIC horaire (5 409 €) × 17,87 % — permet 3 trimestres de retraite",
      },
      invalidite_deces: {
        assiette_minimale: PASS_2026 * 0.115,
        taux: 0.013,
        montant: 72,
        note: "11,5 % PASS (5 527 €) × 1,30 %",
      },
      csg_crds: {
        assiette_minimale: null,
        taux: 0.097,
     ...
     * LFSS 2024 art. 18 — entrée en vigueur effective avril 2026.
     *
     * Formule :
  ...
  sante: {
    ...
    CFG_CARMF_2026: {
      retraite_base: {
        ...
        cotisation_maximale: 8_690,
        note: "8,73 % ≤ 1 PASS + 1,87 % ≤ 5 PASS. Max = 8 690 € = 4 196 € (T1) + 4 494 € (T2)",
      },
      retraite_complementaire: {
        taux: 0.118,
    ...
    CFG_CARPIMKO_2026: {
      ...
      retraite_complementaire: {
        ...
        assiette_max_pass: 3,
        montant_min_2026: 2_091,
        montant_max_2026: 12_544,
        note: "8,70 % sur assiette entre 0,5 et 3 PASS (24 030 € à 144 180 €)",
      },
      asv: {
        forfait_total: 671,
        part_adherent: 224,
    ...
    CFG_PARAM_AIDE_CPAM_RETRAITE: {
      asv_part_forfaitaire_totale_2026: 5_751,
      asv_part_medecin_secteur_1: 1_917,
      asv_part_cpam_secteur_1: 3_834,
      asv_part_medecin_secteur_2: 5_751,
      asv_part_cpam_secteur_2: 0,
      asv_taux_proportionnel_medecin_s1: 0.013333,
      asv_taux_proportionnel_cpam_s1: 0.025333,
      asv_taux_proportionnel_medecin_s2: 0.04,
      asv_plafond_assiette: PASS_2026 * 5,
      asv_seuil_proportionnalite_integrale: 63_900,
      note:
        "Proportionnalité intégrale possible si revenus conventionnels N-2 < 63 900 €. " +
        "Assiette : revenus conventionnels N-2, plafond 5 PASS (240 300 €). " +
  ...
  culture: {
    ...
    CFG_TAUX_COTISATIONS_ARTISTE_AUTEUR: {
      ...
      seuil_validation_trimestre_retraite: 1_803,
      seuil_validation_annee_complete_retraite: 7_212,
    },
  ...
  immobilier: {
     ...
     * Même barème que TNS BIC — voir CFG_TAUX_SOCIAL_TNS_BIC.
     * Taux effectif estimé : 35-45 % du bénéfice BIC net.
     * Cotisation minimale forfaitaire si résultat nul ou négatif (~1 208 €/an).
     */
    CFG_TAUX_SOCIAL_LMP_SSI: {
      regime: "TNS_SSI — barème identique artisans/commerçants",
      taux_effectif_estime_min: 0.35,
      taux_effectif_estime_max: 0.45,
      cotisation_minimale_annuelle_estimee: 1_208,
      renvoi: "CFG_TAUX_SOCIAL_TNS_BIC pour le détail par branche",
    },
