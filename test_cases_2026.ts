...
function ir_bareme_2026(revenu_net_imposable: number, nb_parts = 1): number {
...
export const TEST_CASES: TestCase[] = [
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "RFR N-2 = 20000 < seuil VFL (29315 × 1) → éligible. " +
      "Cotisations = 80000 × 0.123 = 9840. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "TVA nette due = 12000 - 1000 = 11000. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "RFR N-2 = 25000 < 29315 × 1 → éligible VFL. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "RFR N-2 = 35000 > seuil VFL (29315 × 1 part). " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Résultat = 70000, assiette ASU = 51800, identique TC-G-009. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "IS = 42500 × 0.15 + 27500 × 0.25 = 6375 + 6875 = 13250. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Charges patronales assimilé-salarié ~35.32% sur brut. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "DATE_CREATION = 2026-03-01 < 2026-07-01 → taux réduction ACRE = 50 %. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "DATE_CREATION = 2026-09-01 > 2026-07-01 → taux réduction ACRE = 25 %. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Cotisations ACRE 50% = 55000 × 0.256 × 0.50 = 7040. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "ZFRR année 1 : taux exonération 100 %. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "EURL IR : transparence fiscale, calcul identique à EI réel BNC IR sur même résultat. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "RSPM tranche 1 (≤ 19000) : taux 13.5%. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "RSPM tranche 2 (19001-38000) : taux 21.2%. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Aide CPAM maladie S1 : CPAM prend en charge ~8.4% sur revenus conventionnés. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Déductions S1 : Groupe III = 2% × 100000 = 2000 (< 3050 max). " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Assiette SSAA BNC micro = 25000 × 0.66 × 1.15 = 18975. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Assiette SSAA T&S = 30000 × 98.25% = 29475 (revenus ≤ 4 PASS). " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "LMNP micro-BIC : abattement 50% sur 18000 = 9000. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Art. 39C non limitant ici (amortissement 6000 < résultat hors amort 16000). " +
      "PS = 17.2% × 10000 = 1720. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Art. 39C : résultat hors amort = 2000 €, amort max = 2000 €. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "CA 42000 > seuil majoré BNC 41250 → TVA applicable dès le 15/10/2026. " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Revenus activité = CA × (1-taux_cotisations) ≈ 9018 < 9612 (20% PASS). " +
  ...
  // ════════════════════════════════════════════════════════════════════════════
  {
    ...
    calcul_notes:
      "Méthode différentielle sur foyer 2 parts. " +
...
export const TEST_CASES_BY_SCENARIO: Record<string, TestCase[]> = TEST_CASES.reduce(
  (acc, tc) => {
    if (!acc[tc.scenario_base]) acc[tc.scenario_base] = [];
...
export const TEST_CASES_BY_SEGMENT: Record<string, TestCase[]> = TEST_CASES.reduce(
  (acc, tc) => {
...
export const SUMMARY = {
  ...
  par_segment: {
    generaliste: TEST_CASES.filter((t) => t.segment === "generaliste").length,
    sante: TEST_CASES.filter((t) => t.segment === "sante").length,
    artiste_auteur: TEST_CASES.filter((t) => t.segment === "artiste_auteur").length,
    immobilier: TEST_CASES.filter((t) => t.segment === "immobilier").length,
  },
  fiabilite: {
    complet: TEST_CASES.filter((t) => t.expected.niveau_fiabilite === "complet").length,
    estimation: TEST_CASES.filter((t) => t.expected.niveau_fiabilite === "estimation").length,
    partiel: TEST_CASES.filter((t) => t.expected.niveau_fiabilite === "partiel").length,
  },
  note:
    "Les cas 'estimation' ont des cotisations TNS réel calculées branche par branche. " +
